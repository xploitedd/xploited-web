...
export type GetPinnedRepositoriesQueryVariables = Exact<{
  userLogin: Scalars['String'];
  limit?: Maybe<Scalars['Int']>;
  languagesLimit?: Maybe<Scalars['Int']>;
}>;
...
/**
 * __useGetPinnedRepositoriesQuery__
 *
 * To run a query within a React component, call `useGetPinnedRepositoriesQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetPinnedRepositoriesQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetPinnedRepositoriesQuery({
 *   variables: {
 *      userLogin: // value for 'userLogin'
 *      limit: // value for 'limit'
 *      languagesLimit: // value for 'languagesLimit'
 *   },
 * });
 */
export function useGetPinnedRepositoriesQuery(baseOptions: Apollo.QueryHookOptions<GetPinnedRepositoriesQuery, GetPinnedRepositoriesQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetPinnedRepositoriesQuery, GetPinnedRepositoriesQueryVariables>(GetPinnedRepositoriesDocument, options);
      }
export function useGetPinnedRepositoriesLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetPinnedRepositoriesQuery, GetPinnedRepositoriesQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetPinnedRepositoriesQuery, GetPinnedRepositoriesQueryVariables>(GetPinnedRepositoriesDocument, options);
        }
export type GetPinnedRepositoriesQueryHookResult = ReturnType<typeof useGetPinnedRepositoriesQuery>;
export type GetPinnedRepositoriesLazyQueryHookResult = ReturnType<typeof useGetPinnedRepositoriesLazyQuery>;
export type GetPinnedRepositoriesQueryResult = Apollo.QueryResult<GetPinnedRepositoriesQuery, GetPinnedRepositoriesQueryVariables>;